...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var availableInstructorStatus = ["pending", "approved", "blocked"];
  var instructorStatusUpdate = document.querySelectorAll(".tutor-instructor-status-update");

  var _iterator4 = _createForOfIteratorHelper(instructorStatusUpdate),
      _step4;

  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      var _status = _step4.value;

      _status.onchange = /*#__PURE__*/function () {
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  target = e.target;
                  newStatus = availableInstructorStatus[target.selectedIndex];
                  prevStatus = target.dataset.status;
                ...
                case 15:
                  ...
                  if (response.success) {
                    target.dataset.status = newStatus;
                    putStatus = "select-default";
                    newStatus === "approved" ? putStatus = "select-success" : newStatus === "pending" ? putStatus = "select-warning" : newStatus === 'blocked' ? putStatus = "select-danger" : "select-default"; // add new status class
  ...
  var _iterator5 = _createForOfIteratorHelper(deleteCourse),
      _step5;
  ...
  function _ajaxHandler() {
    _ajaxHandler = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(formData) {
      var post;
...
function ajaxHandler(_x7) {
  return _ajaxHandler2.apply(this, arguments);
}

function _ajaxHandler2() {
  _ajaxHandler2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(formData) {
    var post;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            tutor_toast(__("Operation failed", "tutor"), _context6.t0, "error");
...
window.selectSearchField = function (selectElement) {
  ...
  var dd_hide_dom_click = function dd_hide_dom_click(elem) {
    if (elem) {
  ...
  if (spotlightTabs && spotlightTabContent) {
    spotlightTabs.forEach(function (tab) {
      tab.addEventListener('click', function (event) {
        ...
        var query_string = event.currentTarget.getAttribute('data-tutor-query-string'); // console.log(query_string);
...
window.jQuery(document).ready(function ($) {
  ...
  var PhotoEditor = function PhotoEditor(photo_editor) {
    ...
    this.upload_selected_image = function (name, file) {
      ...
      form_data.append(nonce.key, nonce.value); // let server_max_size = photo_editor.find('.upload_max_filesize').val();
      ...
      if (this.verify_filesize(file)) {
        ...
        var photoType = this.title_capitalize(name.replace('_', ' '));
    ...
    this.verify_filesize = function (file) {
      var server_max_size = photo_editor.find('.upload_max_filesize').val();
...
/* harmony import */ var _admin_dashboard_segments_lib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../admin-dashboard/segments/lib */ "./assets/react/admin-dashboard/segments/lib.js");
/* harmony import */ var _admin_dashboard_segments_lib__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_admin_dashboard_segments_lib__WEBPACK_IMPORTED_MODULE_6__);
    ...
    if (attempt_meta.time_limit.time_limit_seconds > 0) {
      ...
      var tutor_quiz_interval = setInterval(function () {
        ...
        if (distance) {
          ...
          svg.setAttribute('style', "--quizeProgress: ".concat(100 - progress));
        }
      }, 1000);
    } else {
