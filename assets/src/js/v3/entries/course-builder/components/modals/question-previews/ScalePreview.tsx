...
const ScalePreview = ({ answers }: { answers: QuizQuestionOption[] }) => {
  ...
  const instructionId = `tutor-scale-instruction-${qId}`;
  const liveRegionId = `tutor-scale-live-${qId}`;
    ...
    >
      <div className="tutor-scale-slider-wrapper">
        <div
          ...
          aria-valuetext={String(defaultValue)}
          aria-describedby={instructionId}
          aria-label={__('Interactive scale: drag or use arrow keys to select your answer value.', 'tutor')}
        >
        ...
        <div className="tutor-scale-instructions">
          ...
          <span id={instructionId} className="tutor-scale-instruction-text">
