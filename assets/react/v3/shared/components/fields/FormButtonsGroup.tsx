import { colorPalate, spacing, borderRadius } from '@Config/styles';
import { typography } from '@Config/typography';
import { css } from '@emotion/react';
import { FormControllerProps } from '@Utils/form';
import { styleUtils } from '@Utils/style-utils';
import { OptionWithIcon } from '@Utils/types';
          ...
          <div css={styles.container}>
            {options.map((option) => (
              <button
                ...
                type="button"
                css={styles.itemButton({ isActive: field.value === option.value })}
                onClick={() => {
