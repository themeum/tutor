...
import { type VisibilityContext, type WithVisibilityProps } from '@TutorShared/utils/types';
...
export const withVisibilityControl = <P extends object>(WrappedComponent: ComponentType<WithVisibilityProps<P>>) => {
  return (props: WithVisibilityProps<P>) => {
    ...
    const isVisible = useVisibilityControl({ key, context: context as VisibilityContext });
