 ...
 */
const colorPresetPicker = document.querySelector(".color-preset-picker");
if (colorPresetPicker && "undefined" !== typeof colorPresetPicker) {
  ...
  const otherColorRows = otherColors.querySelectorAll(
