...
class EmptyState extends BaseComponent {
	...
	protected function get_default_icon(): string {
		return '<svg width="89" height="86" viewBox="0 0 89 86" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	public function get(): string {
		$title    = $this->title ?? __( 'No Data Found.', 'tutor' );
		$subtitle = $this->subtitle;

		// Fallback to global empty state subtitle if not provided.
		if ( empty( $subtitle ) ) {
