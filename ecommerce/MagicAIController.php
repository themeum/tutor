...
class MagicAIController {
	...
	private static function generate_prompt( $prompt, $style ) {
		...
		return "I NEED to test how the tool works with extremely simple prompts. DO NOT add any detail, just use it AS-IS: " . str_replace( '{user_prompt}', $prompt, $style_prompt );
	}
	...
	public function generate_image() {
		...
		try {
			...
			return $this->json_response( $error->getMessage() );
		}
	}
