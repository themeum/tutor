...
describe("Tutor Dashboard My Courses", () => {
  ...
  //         cy.get('button').contains("Browse File").click()

  //         cy.get('input[type="file"]').should('exist').selectFile(filePath, {
  //             force: true,
  //           });
  //       cy.get("button").contains("Load Credentials").click()
  //         //   another option change credentials
  //       }

  //       if ($body.text().includes("Please complete the authorization process")) {
  //         cy.get(':nth-child(4) > .tutor-btn').contains("Allow Permissions").click()
  ...
  //     cy.get('table tbody tr').should('have.length.greaterThan', 0).then(()=>{
  //         cy.get(".tutor-copy-text").eq(0).click().then(()=>{
  //             cy.wait(500)
  //             cy.contains("Copied")
  //         })
  //     })
  ...
  //     cy.get('table tbody tr').should('have.length.greaterThan', 0).then(()=>{
  //         cy.get(".tutor-iconic-btn.tutor-mr-n8.tutor-copy-text").click().then(()=>{
  //             cy.wait(500)
  //             cy.contains("Copied")
  //         })
  //     })
...
//     //   }
//     // );
//     cy.get(".tutor-iconic-btn").eq(2).click()
