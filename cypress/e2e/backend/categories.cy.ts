...
describe("Tutor Admin Categories", () => {
  ...
  it("should create a category successfully", () => {
    ...
    cy.get("textarea[name=description]").type(
      "Blockchain category for courses"
    );
    cy.get("#submit").click();
    ...
    cy.get("body").then(($body) => {
      if (
        ...
        cy.get(".wp-list-table tbody .column-name").should(
          "include.text",
          categoryName
        );
      }
  ...
  it("should update a category successfully", () => {
    ...
    cy.get("textarea[name=description]")
      .clear()
      .type("Blockchain category for courses updated");
    cy.get("input[type=submit]").click();

    cy.get(".notice").should("include.text", "Item updated.");

    cy.get(".notice a")
      .contains("Go to Categories")
      .click();
    cy.get(".wp-list-table tbody .column-description").should(
      "include.text",
      "Blockchain category for courses updated"
    );
  });
