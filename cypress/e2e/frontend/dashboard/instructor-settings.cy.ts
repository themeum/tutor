...
describe("Tutor Dashboard Settings", () => {
    ...
    it ("should reset password", () => {
        ...
        cy.getByInputName("previous_password").type(Cypress.env("instructor_password"))
        cy.getByInputName("new_password").type(Cypress.env("instructor_password"))
        cy.getByInputName("confirm_new_password").type(Cypress.env("instructor_password"))
