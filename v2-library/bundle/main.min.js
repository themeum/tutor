...
/***/ "./v2-library/_src/js/tutorAccordion.js":
/*!**********************************************!*\
  !*** ./v2-library/_src/js/tutorAccordion.js ***!
  \**********************************************/
/***/ (() => {
 ...
 * Tutor accrodion
 */
window.tutorAccordion = function (func) {
...
/***/ "./v2-library/_src/js/tutorAccordionRadioFields.js":
/*!*********************************************************!*\
  !*** ./v2-library/_src/js/tutorAccordionRadioFields.js ***!
  \*********************************************************/
/***/ (() => {
...
/***/ "./v2-library/_src/js/tutorGeneral.js":
/*!********************************************!*\
  !*** ./v2-library/_src/js/tutorGeneral.js ***!
  \********************************************/
/***/ (() => {
...
(function tutorPasswordStrengthChecker() {
  var passwordCheckerInput = document.querySelectorAll('.tutor-password-field input.password-checker');
  ...
  if (passwordCheckerInput) {
    passwordCheckerInput.forEach(function (checkerInput) {
      checkerInput.addEventListener('input', function (e) {
        var indicator, noticeText, no;
        var showBtn = checkerInput && checkerInput.closest('.tutor-password-field').querySelector('.show-hide-btn');
        var hintWrapper = checkerInput.closest('.tutor-password-strength-checker');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            content = document.getElementById(id).textContent.trim();
...
var showToolTip = function showToolTip(targetEl) {
  ...
  var toolTip = "<span class=\"tutor-tooltip\">".concat(text, "</span>");
...
document.addEventListener('click', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var copyTargetAttr, pasteTargetAttr, id, text, _id2, _text;

    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            copyTargetAttr = 'data-tutor-clipboard-copy-target';
            pasteTargetAttr = 'data-tutor-clipboard-paste-target';
            ...
            id = e.target.getAttribute(copyTargetAttr);
            /* Get the text field */
          ...
          case 9:
            ...
            _id2 = e.target.getAttribute(pasteTargetAttr);
            _context2.next = 13;
            return navigator.clipboard.readText();
          ...
          case 13:
            ...
            if (_text) {
              document.getElementById(_id2).value = _text;
...
/* harmony import */ var _tutorGeneral__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./tutorGeneral */ "./v2-library/_src/js/tutorGeneral.js");
/* harmony import */ var _tutorGeneral__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_tutorGeneral__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _tutorAccordion__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tutorAccordion */ "./v2-library/_src/js/tutorAccordion.js");
