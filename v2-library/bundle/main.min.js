...
(function tutorPasswordStrengthChecker() {
  ...
  var strong = document.querySelector('.tutor-passowrd-strength-hint .strong'); // const text = document.querySelector('.tutor-passowrd-strength-hint .text');
