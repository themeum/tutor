				...
				renderCustomHeader={({
					...
					return (
						<div className="datepicker-header-custom">
							<div
								className={`dropdown-container dropdown-months ${
									dropdownMonth ? 'is-active' : ''
								}`}
							>
								<div
								...
								<ul className="dropdown-list">
									{months.map((option) => (
										<li
											...
											data-value={option}
											className={`${
												option === months[getMonth(date)] ? 'is-current' : ''
											}`}
											onClick={(e) => {
												const {
													target: {
							...
							<div
								className={`dropdown-container dropdown-years ${
									dropdownYear ? 'is-active' : ''
								}`}
							>
								<div
									className="dropdown-label"
								...
								<ul className="dropdown-list">
									{years.map((option) => (
										<li
											...
											data-value={option}
											className={`${
												option === getYear(date) ? 'is-current' : ''
											}`}
											onClick={(e) => {
												const {
													target: {
