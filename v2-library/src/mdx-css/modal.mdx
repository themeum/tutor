...
## Modal - close inside header
Use `className="tutor-modal tutor-modal-close-in-header"`

<Playground>
    <button data-tutor-modal-target="tutor-modal-close-in-header-1" className="tutor-btn">Open modal</button>

    <div id="tutor-modal-close-in-header-1" className="tutor-modal tutor-modal-close-in-header">
