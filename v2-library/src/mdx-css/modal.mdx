        ...
        <div className="tutor-modal-root">
            ...
            <div className="tutor-modal-inner">
                <div className="tutor-modal-body tutor-text-center">
                    ...
                    <div className="tutor-modal-buttons tutor-mt-20 tutor-mt-md-50">
                        <button className="tutor-btn tutor-btn-full ">
                            Approve The Instructor
                        </button>
                        <button data-tutor-modal-close className="tutor-btn tutor-is-outline tutor-is-default tutor-btn-full tutor-mt-25">
