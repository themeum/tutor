            ...
            <div className="tutor-modal-inner">
                <div className="tutor-modal-body tutor-text-center">
                    <div className="tutor-modal-text-wrap">
                        <div className="text-regular-h4 color-text-primary">A New Instructor Just Signed Up</div>
                        <div className="text-regular-small color-text-subsued tutor-mt-10">You can either accept or reject the application. The applicant will be notified via email either way.</div>
                    </div>
                    <div className="tutor-modal-ins-meta tutor-mt-44">
                        ...
                        <div className="text-medium-h4 color-text-primay tutor-mt-20">Lewis Jennifar</div>
                        <div className="text-regular-body color-text-title tutor-mt-8">Username: <span className="color-text-primary">lewisjennifar</span></div>
                        <div className="text-regular-body color-text-title tutor-mt-3">Email: <span className="color-text-primary">lewisjennifar@gmail.com</span></div>
                    </div>
                ...
                <div className="tutor-modal-body tutor-text-center">
                    ...
                    <div class="tutor-alert tutor-warning tutor-mt-30">
                        <div class="tutor-alert-text">
                            ...
                            <span class="color-warning-100">WARNING! This will overwrite all existing settings, please proceed with caution.</span>
                        </div>
                    </div>
