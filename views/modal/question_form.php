...
<div id="tutor-quiz-question-wrapper" data-question-id="
<?php
echo esc_attr( $question_id );
?>
 " data-question_type="
 <?php
	echo esc_attr( $question->question_type );
	?>
 ">
					...
					<div class="tutor-col-12 tutor-col-md-12">
						<div class="question-type-select">
							...
							<div class="select-header">
								...
								<input type="hidden" class="tutor_select_value_holder" name="tutor_quiz_question[<?php echo esc_attr( $question_id ); ?>][question_type]" value="<?php echo esc_attr( $question->question_type ); ?>">
							</div>
							...
							<div class="tutor-select-options" style="display: none;">
								...
								foreach ( $question_types as $type => $question_type ) {
									...
									<p class="tutor-select-option" data-value="<?php echo $type; ?>" <?php echo $question->question_type === $type ? ' data-selected="selected"' : ''; ?> data-is-pro="<?php echo ( ! $has_tutor_pro && $question_type['is_pro'] ) ? 'true' : 'false'; ?>">
										<?php echo $question_type['icon'] . ' ' . $question_type['name']; //phpcs:ignore ?>
