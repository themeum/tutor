...
<div class="quiz-questions-form">
	...
	<div class="question-form-header">
		<a href="javascript:;" class="back-to-quiz-questions-btn open-tutor-quiz-modal" data-quiz-id="<?php echo esc_attr( $quiz_id ); ?>" data-back-to-tab="#quiz-builder-tab-questions"><i class="tutor-icon-next-2"></i> <?php _e( 'Back', 'tutor' ); ?></a>
	</div>
									...
									<div class="tutor-quiz-answer">
										...
										if ( $question->question_type === 'true_false' || $question->question_type === 'single_choice' ) {
											...
											<span class="tutor-quiz-answers-mark-correct-wrap">
												<input type="radio" name="mark_as_correct[<?php echo esc_attr( $answer->belongs_question_id ); ?>]" value="<?php echo esc_attr( $answer->answer_id ); ?>" title="<?php esc_attr_e( 'Mark as correct', 'tutor' ); ?>" <?php checked( 1, $answer->is_correct ); ?> >
											</span>
											<?php
											} elseif ( $question->question_type === 'multiple_choice' ) {
												?>
												<span class="tutor-quiz-answers-mark-correct-wrap">
													<input type="checkbox" name="mark_as_correct[<?php echo esc_attr( $answer->belongs_question_id ); ?>]" value="<?php echo esc_attr( $answer->answer_id ); ?>" title="<?php esc_attr_e( 'Mark as correct', 'tutor' ); ?>" <?php checked( 1, $answer->is_correct ); ?> >
												</span>
												<?php
												}
												?>
