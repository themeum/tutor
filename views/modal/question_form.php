...
<div id="tutor-quiz-question-wrapper" data-question-id="<?php echo esc_attr( $question_id );; ?>" data-question_type="<?php echo esc_attr( $question->question_type );; ?>">
	<div class="question-form-header tutor-mb-12">
		<a href="javascript:;" class="back-to-quiz-questions-btn tutor-btn tutor-btn-ghost" data-quiz-id="<?php echo esc_attr( isset( $quiz_id ) ? $quiz_id : '' ); ?>" data-topic-id="<?php echo esc_attr( isset( $topic_id ) ? $topic_id : '' ); ?>">
	...
	<div class="tutor-mb-32">
		...
		<div class="tutor-mb-16">
			<input type="text" name="tutor_quiz_question[<?php echo esc_attr( $question_id ); ?>][question_title]" class="tutor-form-control" placeholder="<?php esc_attr_e( 'Type your question here', 'tutor' ); ?>" value="<?php echo htmlspecialchars( stripslashes( $question->question_title ) ); //phpcs:ignore ?>">
		</div>
	</div>
						...
						<div class="question-type-select">
							...
							<div class="select-header">
								<span class="lead-option">
									<?php
									echo $question_types[ $current_type ]['icon'];
	...
	<div class="tutor-mb-32">
		...
		<div class="tutor-mb-16">
			<textarea name="tutor_quiz_question[<?php echo $question_id; ?>][question_description]" id="tutor-quiz-question-desc" class="tutor-form-control"><?php echo stripslashes( $question->question_description ); ?></textarea>
		</div>
	</div>
