		...
		<div class="tutor-quiz-builder-group">
			...
			<div class="tutor-quiz-builder-row">
				<div class="tutor-quiz-builder-col auto-width">
					<label>
						<input type="radio" name="quiz_answer[<?php echo esc_attr( $question_id ); ?>][answer_view_format]" value="text" <?php echo esc_attr( $answer_view_format ? checked( 'text', $answer_view_format ) : 'checked' ); ?>
						> <?php _e( 'Only text', 'tutor' ); ?>
					</label>
				</div>
				<div class="tutor-quiz-builder-col auto-width">
					<label><input type="radio" name="quiz_answer[<?php echo esc_attr( $question_id ); ?>][answer_view_format]" value="image" <?php echo esc_attr( checked( 'image', $answer_view_format ) ); ?>><?php _e( 'Only Image', 'tutor' ); ?></label>
				</div>
				<div class="tutor-quiz-builder-col auto-width">
					<label>
