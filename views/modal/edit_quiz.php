...
<div class="tutor-quiz-builder-modal-contents">
		...
		<div id="quiz-builder-tab-quiz-info" class="quiz-builder-tab-container">
				...
				<div class="tutor-quiz-builder-group">
					<div class="tutor-quiz-builder-row">
						<div class="tutor-quiz-builder-col">
							<input type="text" name="quiz_title" placeholder="<?php _e( 'Type your quiz title here', 'tutor' ); ?>" value="<?php echo stripslashes( esc_attr( $quiz->post_title ) ); ?>">
						</div>
					</div>
			...
			<div class="tutor-quiz-builder-modal-control-btn-group">
				...
				<div class="quiz-builder-btn-group-right">
					<a href="#quiz-builder-tab-questions" class="quiz-modal-tab-navigation-btn  quiz-modal-btn-cancel">
					<?php
					_e( 'Cancel', 'tutor' );
					?>
																														</a>
							...
							<div class="quiz-builder-question-wrap" data-question-id="<?php echo esc_attr( $question->question_id ); ?>">
								<div class="quiz-builder-question">
									...
									<span class="question-edit-icon">
										<a href="javascript:;" class="tutor-quiz-open-question-form" data-question-id="<?php echo esc_attr( $question->question_id ); ?>">
								...
								<div class="quiz-builder-qustion-trash">
									<a href="javascript:;" class="tutor-quiz-question-trash" data-question-id="<?php echo esc_attr( $question->question_id ); ?>">
	...
	<div class="tutor-quiz-builder-modal-tabs-notice">
		...
		printf( __( 'Need any Help? Please visit our %1$s and %2$s.', 'tutor' ), $knowledge_base_link, $documentation_link );
		?>
	</div>
