        ...
        <div class="tutor-quiz-advance-content tutor-p-32">
            <div class="tutor-quiz-advance-settings-fields tutor-row">
                ...
                <div class="tutor-col-12 tutor-mb-32">
                    ...
                    <div class="tutor-form-feedback">
                        <?php _e('Show/hide question number during attempt.', 'tutor'); ?>
                    </div>
                </div>

                <div class="tutor-col-12 tutor-mb-32">
                    <label class="tutor-form-label">
                        <?php _e('Short answer characters limit', 'tutor'); ?>
                    </label>
                    <div class="tutor-row">
                        <div class="tutor-col-auto">
                    ...
                    <div class="tutor-form-feedback">
                        <?php _e('Student will place answer in short answer question type within this characters limit.', 'tutor'); ?>
                    </div>
                </div>
