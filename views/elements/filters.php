...
<div class="tutor-px-20">
	<div class="tutor-wp-dashboard-filter tutor-d-flex tutor-align-items-end tutor-justify-content-<?php echo esc_attr( isset( $data['bulk_action'] ) && true === $data['bulk_action'] ? 'between' : 'end' ); ?>">
