...
<tr class="answer-option-row" data-answer-option-id="<?php echo $quiz_answer_option->comment_ID; ?>">
	...
	<td>
		<input name="dozent_question[<?php echo $question_id; ?>][answer_option_is_correct][<?php echo $quiz_answer_option->comment_ID; ?>]" type="checkbox" value="1" <?php checked('1', dozent_utils()->avalue_dot('is_correct', $answer_option)); ?>>
	</td>
