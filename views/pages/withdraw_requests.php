			...
			<div class="tutor-modal-body tutor-text-center " style="padding: 60px 50px;">
				<form action="" id="tutor-admin-withdraw-approve-form">
					...
					<div class="tutor-modal-text-wrap">
						<h3 class="tutor-modal-title tutor-fs-4 text-primary">
							<?php esc_html_e( 'Approve Withdrawal?', 'tutor' ); ?>
						</h3>
						<p id="tutor-admin-withdraw-approve-content" class="tutor-fs-6 tutor-color-black-60">
					...
					<button type="submit" class="tutor-btn tutor-btn-primary tutor-btn-loading tutor-btn-lg">
				...
				<div class="tutor-modal-body tutor-text-center">
					<form action="" id="tutor-admin-withdraw-reject-form">
						...
						<div class="tutor-mb-40">
							<div class="tutor-modal-title tutor-fs-4 text-primary">
								<?php esc_html_e( 'Reject Withdrawal?', 'tutor' ); ?>
							</div>
							<div id="tutor-admin-withdraw-reject-content" class="tutor-fs-6 tutor-color-black-60 tutor-mb-32">
						...
						<div class="tutor-modal-btns_ tutor-btn-group_ tutor-d-flex tutor-align-items-center tutor-justify-between tutor-flex-wrap ">
							<button
								data-tutor-modal-close
								class="tutor-btn tutor-btn-outline-primary tutor-btn-lg">
								<?php esc_html_e( 'Cancel', 'tutor' ); ?>
							</button>
							<button type="submit" class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-btn-loading">
