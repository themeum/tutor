...
<div class="wrap">
	...
	<table class="tutor_status_table widefat" cellspacing="0" id="status">
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The homepage URL of your site.', 'tutor' ) ) ); ?></td>
			<td><?php echo esc_html( $environment['home_url'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Site URL"><?php esc_html_e( 'Site URL', 'tutor' ); ?>:</td>
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The root URL of your site.', 'tutor' ) ) ); ?></td>
			<td><?php echo esc_html( $environment['site_url'] ); ?></td>
		</tr>

		<tr>
			<td data-export-label="WP Version"><?php esc_html_e( 'WordPress version', 'tutor' ); ?>:</td>
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The version of WordPress installed on your site.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The version of tutor.', 'tutor' ) ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Whether or not you have WordPress Multisite enabled.', 'tutor' ) ) ); ?></td>
			<td><?php echo _esc_html(( $environment['wp_multisite'] ) ? '<span class="dashicons dashicons-yes"></span>' : '&ndash;'); ?></td>
		</tr>
		<tr>
			<td data-export-label="WP Memory Limit"><?php esc_html_e( 'WordPress memory limit', 'tutor' ); ?>:</td>
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The maximum amount of memory (RAM) that your site can use at one time.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Displays whether or not WordPress is in Debug Mode.', 'tutor' ) ) ); ?></td>
			<td>
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Displays whether or not WP Cron Jobs are enabled.', 'tutor' ) ) ); ?></td>
			<td>
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The current language used by WordPress. Default = English', 'tutor' ) ) ); ?></td>
			<td><?php echo esc_html( $environment['language'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="External object cache"><?php esc_html_e( 'External object cache', 'tutor' ); ?>:</td>
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Displays whether or not WordPress is using an external object cache.', 'tutor' ) ) ); ?></td>
			<td>
	...
	<table class="tutor_status_table widefat" cellspacing="0">
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Information about the web server that is currently hosting your site.', 'tutor' ) ) ); ?></td>
			<td><?php echo esc_html( $environment['server_info'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="PHP Version"><?php esc_html_e( 'PHP version', 'tutor' ); ?>:</td>
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The version of PHP installed on your hosting server.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
		...
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			<tr>
				...
				<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The largest filesize that can be contained in one post.', 'tutor' ) ) ); ?></td>
				<td><?php echo esc_html( size_format( $environment['php_post_max_size'] ) ); ?></td>
			</tr>
			<tr>
				<td data-export-label="PHP Time Limit"><?php esc_html_e( 'PHP time limit', 'tutor' ); ?>:</td>
				<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The amount of time (in seconds) that your site will spend on a single operation before timing out (to avoid server lockups)', 'tutor' ) ) ); ?></td>
				<td><?php echo esc_html( $environment['php_max_execution_time'] ); ?></td>
			</tr>
			<tr>
				<td data-export-label="PHP Max Input Vars"><?php esc_html_e( 'PHP max input vars', 'tutor' ); ?>:</td>
				<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The maximum number of variables your server can use for a single function to avoid overloads.', 'tutor' ) ) ); ?></td>
			...
			<tr>
				...
				<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The version of cURL installed on your server.', 'tutor' ) ) ); ?></td>
				<td><?php echo esc_html( $environment['curl_version'] ); ?></td>
			</tr>
			<tr>
				<td data-export-label="SUHOSIN Installed"><?php esc_html_e( 'SUHOSIN installed', 'tutor' ); ?>:</td>
				<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Suhosin is an advanced protection system for PHP installations. It was designed to protect your servers on the one hand against a number of well known problems in PHP applications and on the other hand against potential unknown vulnerabilities within these applications or the PHP core itself. If enabled on your server, Suhosin may need to be configured to increase its data submission limits.', 'tutor' ) ) ); ?></td>
		...
		if ( $environment['mysql_version'] ) :
			...
			<tr>
				...
				<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The version of MySQL installed on your hosting server.', 'tutor' ) ) ); ?></td>
				<td>
					<?php
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The largest filesize that can be uploaded to your WordPress installation.', 'tutor' ) ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'The default timezone for your server.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Payment gateways can use cURL to communicate with remote servers to authorize payments, other plugins may also use it when communicating with remote services.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'HTML/Multipart emails use DOMDocument to generate inline CSS in templates.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'GZip (gzopen) is used to open the GEOIP database from MaxMind.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo _esc_html( tutor_utils()->help_tip( esc_html__( 'Multibyte String (mbstring) is used to convert character encoding, like for emails or converting characters to lowercase.', 'tutor' ) ) ); ?></td>
			<td>
				<?php
