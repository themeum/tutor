...
<div class="wrap tutor-uninstall-wrap">
    ...
    <div class="tutor-uninstall-btn-group">
        ...
        <a href="<?php echo esc_url( wp_nonce_url( 'plugins.php?action=deactivate&amp;plugin=' . urlencode( $plugin_file ) . '&amp;plugin_status=all&amp;paged=1&amp;s=', 'deactivate-plugin_' . $plugin_file ) ); ?>" class="tutor-button button-warning"> Deactive </a>
