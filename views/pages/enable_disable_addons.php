                ...
                <div id="the-list">
					...
					foreach ( $addons as $basName => $addon ) {
                        ...
                        <div class="plugin-card plugin-card-akismet">
							...
							if ( function_exists( 'tutor_notifications' ) && $basName == tutor_notifications()->basename ) {
								...
								foreach ( array( 'curl', 'gmp', 'mbstring', 'openssl' ) as $ext ) {
									! extension_loaded( $ext ) ? $required[] = 'PHP extension <strong>' . $ext . '</strong> not found and is required for push notification.' : 0;
								}
