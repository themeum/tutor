                        ...
                        <div class="col-auto">
                            <div class="tutor-logo-section">
                                <a href="https://www.themeum.com/product/tutor-lms/">
                                    <img src="https://api.tutorlms.com/wp-json/restapi/v1/tutor-assets/tutor-logo.png" alt="tutor logo">
                                </a>
                            </div>
                    ...
                    <div class="tutor-updated-features d-flex">
                        <div class="tutor-welcome-card-column-left">
                            <div class="tutor-w-feature-card text-center">
                                <img src="https://api.tutorlms.com/wp-json/restapi/v1/tutor-assets/tutor-welcome-card-3.png" alt="updated dashboard">
                            </div>    
                        </div>
                        <div class="tutor-welcome-card-column-right tutor-w-pl">
                            <div class="tutor-w-feature-card text-center">
                                <img src="https://api.tutorlms.com/wp-json/restapi/v1/tutor-assets/tutor-welcome-card-2.png" alt="design system">
                                <img class="tutor-w-mt" src="https://api.tutorlms.com/wp-json/restapi/v1/tutor-assets/tutor-welcome-card-4.png" alt="advanced Analyst">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tutor-updated-cards-section-2">
                    <div class="col-auto">
                        <div class="tutor-w-feature-card text-center tutor-w-mt">
                            <img src="https://api.tutorlms.com/wp-json/restapi/v1/tutor-assets/tutor-welcome-card-1.png" alt="customize feature">
                        </div>   
                    </div>
                </div>
                <div class="tutor-updated-cards-section-3">
                    <div class="tutor-updated-features d-flex tutor-w-mt">
                        <div class="tutor-welcome-feature-column-left">
                            <div class="tutor-w-feature-card text-center">
                                <img src="https://api.tutorlms.com/wp-json/restapi/v1/tutor-assets/tutor-welcome-card-5.png" alt="updated notification">
                            </div>    
                        </div>
                        <div class="tutor-welcome-feature-column-right tutor-w-pl">
                            <div class="tutor-w-feature-card text-center">
                                <img src="https://api.tutorlms.com/wp-json/restapi/v1/tutor-assets/tutor-welcome-card-6.png" alt="add new features">
                            </div>
                        </div>
                    </div>
                </div>
