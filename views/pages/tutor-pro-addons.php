							...
							<div class="plugin-card-top">
								...
								<div class="action-links">
									<ul class="plugin-action-buttons">
										<li>
											<a href="https://www.themeum.com/product/tutor-lms/?utm_source=tutor&utm_medium=addons_lists&utm_campaign=tutor_addons_lists" class="addon-buynow-link" target="_blank"><?php _e( 'Buy Now', 'tutor' ); ?></a>
										</li>
									</ul>
								</div>
