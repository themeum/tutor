            ...
            <div class="type-check d-flex">
                <?php foreach ($field['options'] as $optionKey => $option) : ?>
                    ...
                    <div class="tutor-form-check">
                        <input type="checkbox" id="tutor_check_<?php echo $optionKey ?>_<?php echo $field['key'] ?>" name="tutor_option[<?php echo $field['key'] ?>][]" value="<?php echo $optionKey; ?>" <?php echo $$_checked; ?> class="tutor-form-check-input" />
                        <label for="tutor_check_<?php echo $optionKey ?>_<?php echo $field['key'] ?>"> <?php echo $option; ?> </label>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
