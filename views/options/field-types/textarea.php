...
<?php require tutor()->path . 'views/options/template/field_heading.php'; ?>
	...
	<div class="tutor-option-field-input">
		<textarea class="tutor-form-control" name="tutor_option[<?php echo esc_attr( $field_key ); ?>]" rows="10" placeholder="<?php echo esc_attr( $field['desc'] ); ?>"><?php echo wp_kses_post( $this->get( $field_key ) ); ?></textarea>
	</div>
</div>
