				...
				<ul class="tutor-dashboard-permalinks">
					...
					foreach ( $dashboard_pages as $dashboard_key => $dashboard_page ) {
						...
						if ( $separator ) {
							...
							echo "<li class='tutor-dashboard-menu-item {$li_class}  {$active_class}'>{$menu_icon}<a href='" . $menu_link . "' class='tutor-text-regular-body tutor-color-text-primary'>{$menu_title}</a></li>";
						}
					}
					?>
				</ul>
