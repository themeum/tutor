...
<form method="post" class="tutor-reset-password-form tutor-ResetPassword lost_reset_password">
	...
	<input type="hidden" name="reset_key" value="<?php echo esc_attr( tutils()->array_get('reset_key', tutor_sanitize_data($_GET)) ); ?>" />
	<input type="hidden" name="user_id" value="<?php echo esc_attr( tutils()->array_get('user_id', tutor_sanitize_data($_GET)) ); ?>" />
