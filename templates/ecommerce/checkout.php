	...
	<div class="tutor-row tutor-g-0">
		<div class="tutor-col-md-6">
			<div class="tutor-checkout-billing">
				<form>
					<h4 class="tutor-fs-3 tutor-fw-bold tutor-color-black tutor-mb-48">Checkout</h4>
					<h5 class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24">Billing Address</h5>
			...
			<div class="tutor-checkout-details">
							...
							<div class="tutor-checkout-course-content">
								<div>
									<h6 class="tutor-checkout-course-title">
										<a href="#">Mastering User Experience Design from Basics to Advanced Techniques and Strategies</a>
									</h6>
								...
								<div class="tutor-text-right">
									<div class="tutor-fw-bold">$95.00</div>
									<div class="tutor-checkout-discount-price">$100.00</div>
								</div>
							</div>
						</div>
						<div class="tutor-checkout-course-item">
				...
				<div class="tutor-checkout-summary tutor-p-32 tutor-border-bottom">
					...
					<div class="tutor-checkout-summary-item">
						...
						<button class="tutor-btn tutor-btn-link"><?php esc_html_e( 'Click here', 'tutor' ); ?></button>
					</div>
					<form class="tutor-checkout-coupon-form">
						<input type="text" placeholder="<?php esc_html_e( 'Add coupon code', 'tutor' ); ?>">
						<button class="tutor-btn tutor-btn-secondary"><?php esc_html_e( 'Apply', 'tutor' ); ?></button>
					</form>
					<div class="tutor-checkout-summary-item">
				...
				<div class="tutor-p-32">
					...
					<button class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-w-100 tutor-justify-center">
