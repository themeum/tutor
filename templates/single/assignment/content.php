...
<div class="tutor-single-page-top-bar tutor-d-flex tutor-justify-between">
    <div class="tutor-topbar-left-item tutor-d-flex">
        <div
            class="tutor-topbar-item tutor-topbar-sidebar-toggle tutor-hide-sidebar-bar tutor-d-flex tutor-align-items-center tutor-d-none tutor-d-xl-flex">
...
<div class="tutor-quiz-wrapper tutor-quiz-wrapper tutor-d-flex justify-content-center tutor-mt-36 tutor-pb-80">
    <div id="tutor-assignment-wrap"
        ...
        <div
            class="tutor-assignment-meta-info tutor-d-flex tutor-justify-between tutor-mt-24 tutor-mt-sm-32 tutor-py-16 tutor-py-sm-24">
		...
		*/
        ...
        <div class="tutor-assignment-description-details tutor-assignment-border-bottom tutor-pb-32 tutor-pb-sm-44">
            <div class="tutor-pt-40 tutor-pt-sm-60 <?php echo esc_attr( strlen( $s_content ) > 500 ? 'tutor-ad-body has-show-more' : '' ); ?>"
                id="content-section">
                ...
                <div class="tutor-show-more-btn tutor-pt-12">
                    <button
                        class="tutor-btn tutor-btn-icon tutor-btn-outline-primary tutor-btn-ghost tutor-no-hover tutor-btn-lg"
                        id="showBtn">
                        <span class="btn-icon tutor-icon-plus tutor-color-design-brand" id="no-icon"></span>
        ...
        <div class="tutor-assignment-footer tutor-d-flex tutor-justify-end tutor-pt-32 tutor-pt-sm-44">
            <a href="<?php echo esc_url( get_permalink( $next_prev_content_id->next_id ) ); ?>"
                class="tuttor-assignment-skip-button tutor-btn tutor-btn-outline-primary tutor-no-hover tutor-btn-lg tutor-mt-md-0 tutor-mt-12">
        ...
        <div class="tutor-assignment-footer tutor-pt-32 tutor-pt-sm-44">
            <div class="tutor-assignment-footer-btn tutor-d-flex tutor-justify-between">
                ...
                <a href="<?php echo esc_url( get_permalink( $next_prev_content_id->next_id ) ); ?>"
                    class="tutor-btn tutor-btn-outline-primary tutor-no-hover tutor-btn-lg tutor-mt-md-0 tutor-mt-12">
                    <?php esc_html_e( 'Skip To Next', 'tutor' ); ?>
                </a>
                <?php endif; ?>
            </div>
