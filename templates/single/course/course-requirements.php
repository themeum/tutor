		...
		<ul class="tutor-course-details-widget-list">
			<?php
				foreach ($course_requirements as $requirement){
					echo "<li class='tutor-d-flex tutor-color-text-primary tutor-text-regular-body tutor-mb-12'><span class='tutor-icon-mark-filled tutor-color-design-brand tutor-mr-4'></span><span>{$requirement}</span></li>";
				}
			?>
		</ul>
	</div>
