...
?>
	...
	if ( $is_course_in_user_cart && ! $buy_now ) {
		...
		<a id="tutor-native-view-cart" href="<?php echo esc_url( $cart_page_url ? $cart_page_url : '#' ); ?>" class="tutor-btn tutor-btn-outline-primary tutor-mt-24 tutor-btn-lg tutor-btn-block <?php echo esc_attr( $cart_page_url ? '' : 'tutor-cart-page-not-configured' ); ?>">
		...
		?>
	<div class="tutor-mt-24">
		<button type="button" id="tutor-native-add-to-cart" class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-btn-block <?php echo esc_attr( $required_loggedin_class ); ?>" data-course-id="<?php echo esc_attr( $course_id ); ?>" data-course-single>
