		...
		<ul class="tutor-course-details-widget-list">
			<?php
				foreach ($target_audience as $audience){
					echo "<li class='tutor-d-flex tutor-color-text-primary tutor-text-regular-body tutor-mb-10'><span class='tutor-icon-mark-filled tutor-color-design-brand tutor-mr-5'></span><span>{$audience}</span></li>";
				}
			?>
		</ul>
	</div>
