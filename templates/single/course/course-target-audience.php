		...
		<ul class="tutor-course-details-widget-list tutor-fs-6 tutor-color-black">
			<?php
				foreach ($target_audience as $audience){
					echo "<li class='tutor-d-flex tutor-mb-12'><span class='tutor-icon-mark tutor-color-design-brand tutor-mr-12 tutor-mt-4' area-hidden='true'></span><span>{$audience}</span></li>";
				}
			?>
		</ul>
	</div>
