...
<ul class="tutor-nav" tutor-priority-nav>
	<?php
		foreach ( $course_nav_item as $nav_key => $nav_item ) {
			...
			?>
				<li>
					<a class="tutor-nav-item<?php echo $nav_key == $default_active_key ? ' is-active' : ''; ?>" href="#" data-tutor-nav-target="tutor-course-details-tab-<?php echo $nav_key; ?>"><?php echo $nav_item['title']; ?></a>
				</li>
			<?php
		}
	?>
	<li class="tutor-nav-more tutor-d-none">
		<a class="tutor-nav-item tutor-nav-more-item" href="#"><span class="tutor-mr-4">More</span> <span class="icon-seemore tutor-icon-times"></span></a>
