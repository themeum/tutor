			...
			<div class="single-instructor-wrap">
				...
				<div class="single-instructor-bottom">
					<div class="ratings">
						...
						echo ' <span class="rating-total-meta">(' . esc_attr( $instructor_rating->rating_count ) . ' ' . __( 'ratings', 'tutor' ) . ')</span> ';
						?>
					</div>
					...
					<div class="courses">
						<p>
							...
							<?php echo esc_attr( tutor_utils()->get_course_count_by_instructor( $instructor->ID ) ); ?> <span class="tutor-text-mute"> <?php _e( 'Courses', 'tutor' ); ?></span>
						</p>
					</div>
