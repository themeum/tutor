...
$tutor_form_class = apply_filters(
	'tutor_enroll_form_classes',
	array(
		'tutor-enroll-form',
	)
);
...
<div class="tutor-single-add-to-cart-box <?php echo esc_attr( $required_loggedin_class ); ?> " data-login_page_url="<?php echo esc_url( $auth_url ); ?>">
	<?php
