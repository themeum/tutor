	...
	<ul class="tutor-quiz-meta">
		...
		if ( $total_questions ) {
			...
			<li>
				...
				<?php echo esc_attr( $total_questions ); ?>
			</li>
			<?php
		}
		...
		if ( $time_limit ) {
			...
			<?php echo esc_attr( $time_limit ) . ' ' . sprintf( __( '%s', 'tutor' ), isset( $available_time_type[ $time_type ] ) ? $available_time_type[ $time_type ] : $time_type ); ?>
			</li>
			<?php
		}
		...
		if ( $attempted_count ) {
			...
			<li>
				...
				<?php echo esc_attr( $attempted_count ); ?>
			</li>
			<?php
		}
		?>
		...
		if ( $passing_grade ) {
			...
			<li>
				...
				<?php echo esc_attr( $passing_grade ) . '%'; ?>
