    ...
    <div id="tutor-quiz-image-multiple-choice" class="tutor-quiz-wrap">
        <div class="tutor-image-checkbox">
            ...
            <label for="<?php echo $answer->answer_id; ?>" class="tutor-form-check-input">
                <input type="radio" class="tutor-form-check-input" id="<?php echo $answer->answer_id; ?>" name="attempt[<?php echo $is_started_quiz->attempt_id; ?>][quiz_question][<?php echo $question->question_id; ?>]" value="<?php echo $answer->answer_id; ?>" />
