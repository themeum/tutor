					...
					<div class="tutor-quiz-border-box" draggable="true">
						<div class="tutor-matching-item">
							...
							if ( 'matching' === $question_type ) {
								$markup = '<span class="tutor-dragging-text-conent tutor-fs-6 tutor-color-black tutor-d-block tutor-mb-8">' . stripslashes( $rand_answer->answer_two_gap_match ) . '</span>';
								echo wp_kses(
									$markup,
									array(
							...
							<?php if ( isset( $rand_answer->image_id ) || 'image' === $rand_answer->answer_view_format || 'text_image' === $rand_answer->answer_view_format ) : ?>
								<div class="tutor-matching-image">
									<?php
