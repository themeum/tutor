...
if ( ! $is_completed_lesson) {
    ...
    <div class="tutor-single-lesson-segment tutor-lesson-complete-form-wrap">
        ...
        <form method="post">
            ...
            <button type="submit" class="course-complete-button tutor-btn" name="complete_lesson_btn" value="complete_lesson"><i class="tutor-icon-mark"></i><?php _e( 'Complete Lesson', 'tutor' ); ?></button>
        </form>
    </div>
	<?php
}
