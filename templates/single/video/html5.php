...
?>
	<div class="tutor-single-lesson-segment tutor-lesson-video-wrap">
		<video poster="<?php echo esc_url( $poster_url ); ?>" id="tutorPlayer" playsinline controls >
			<source src="<?php echo wp_get_attachment_url( $video_info->source_video_id ); ?>" type="<?php echo esc_attr( tutor_utils()->avalue_dot( 'type', $video_info ) ); ?>">
		</video>
	</div>
<?php
