...
<div class="tutor-dashboard-content-inner">
	...
	<div class="tutor-dashboard-inline-links">
		<ul>
			<li class="active"><a href="<?php echo esc_url( tutor_utils()->get_tutor_dashboard_page_permalink( 'enrolled-courses' ) ); ?>"> <?php _e( 'All Courses', 'tutor' ); ?></a> </li>
			<li><a href="<?php echo esc_url( tutor_utils()->get_tutor_dashboard_page_permalink( 'enrolled-courses/active-courses' ) ); ?>"> <?php _e( 'Active Courses', 'tutor' ); ?> </a> </li>
			<li><a href="<?php echo esc_url( tutor_utils()->get_tutor_dashboard_page_permalink( 'enrolled-courses/completed-courses' ) ); ?>">
	...
	if ( $my_courses && $my_courses->have_posts() ) :
		...
		echo _esc_html('<div class="tutor-mycourse-wrap"><div class="tutor-mycourse-content">' . __( 'You haven\'t purchased any course', 'tutor' ) . '</div></div>');
	endif;
