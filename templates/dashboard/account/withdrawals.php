		...
		<div class="tutor-card tutor-card-rounded-2xl">
			...
			<div class="tutor-withdrawal-status">
				<div class="tutor-withdrawal-status-item">
					...
					<div class="tutor-withdrawal-status-item-value"><?php echo esc_html( tutor_utils()->tutor_price( $summary_data->total_income, false ) ); ?></div>
				</div>
				<div class="tutor-withdrawal-status-item">
					...
					<div class="tutor-withdrawal-status-item-value tutor-withdrawal-status-item-value--pending tutor-flex tutor-items-center tutor-gap-3">
						<?php echo esc_html( tutor_utils()->tutor_price( $summary_data->total_pending, false ) ); ?>
						<?php
						Tooltip::make()
				...
				<div class="tutor-withdrawal-status-item">
					...
					<div class="tutor-withdrawal-status-item-value"><?php echo esc_html( tutor_utils()->tutor_price( $summary_data->total_withdraw, false ) ); ?></div>
				</div>
			</div>
		</div>
					...
					<div class="tutor-billing-card">
						...
						<div class="tutor-billing-card-right">
							<div class="tutor-billing-card-amount">
								<?php echo esc_html( tutor_utils()->tutor_price( $withdrawal->amount, false ) ); ?>
