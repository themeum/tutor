...
<div class="tutor-dashboard-content-inner">
	...
	<div class="tutor-dashboard-inline-links">
		<ul>
			<li><a href="<?php echo esc_url( tutor_utils()->get_tutor_dashboard_page_permalink( 'enrolled-courses' ) ); ?>"> <?php _e( 'All Courses', 'tutor' ); ?></a> </li>
			<li class="active"><a href="<?php echo esc_url( tutor_utils()->get_tutor_dashboard_page_permalink( 'enrolled-courses/active-courses' ) ); ?>"> <?php _e( 'Active Courses', 'tutor' ); ?> </a> </li>
