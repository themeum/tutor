...
<div class="tutor-dashboard-content-inner tutor-dashboard-assignment-review">
	...
	<div class="tutor-assignment-review-header">
		...
		<div class="tutor-row tutor-align-center">
			...
			<div class="tutor-col-lg tutor-mt-8 tutor-mt-lg-0">
				<span class="tutor-fw-medium tutor-color-black"><?php echo esc_attr( date( 'j M, Y, h:i a', strtotime( tutor_utils()->convert_date_into_wp_timezone( $submitted_assignment->comment_date ) ) ) ); ?></span>
			</div>
		</div>
	</div>
