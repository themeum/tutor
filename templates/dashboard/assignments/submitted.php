			...
			<table class="tutor-table tutor-table-middle">
				...
				<tbody>
					...
					foreach ( $assignments_submitted as $assignment ) :
						...
						$deadline_date             = tutor_utils()->get_assignment_deadline_date( $assignment->comment_post_ID, 'Y-m-d H:i:s', __( 'No Limit', 'tutor' ), $assignment->user_id, $assignment->comment_parent );
