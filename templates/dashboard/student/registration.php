<form method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" value="dozent_register_student" name="dozent_action"/>
    ...
    <div class="dozent-form-row">
        <div class="dozent-form-col-12">
            <div class="dozent-form-group dozent-reg-form-btn-wrap">
                <button type="submit" name="dozent_register_student_btn" value="register" class="dozent-button"><?php _e('Register', 'dozent'); ?></button>
            </div>
        </div>
    </div>
