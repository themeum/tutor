                ...
                <div class="tutor-form-col-12">
                    <div class="tutor-form-group">
                        <div class="tutor-form-field">
                            ...
                            <button type="submit" name="course_submit_btn" value="save_course_as_draft"><?php _e('Save course as draft', 'tutor');
                            ?></button>
							...
							if ($can_publish_course){
								...
								?>
                                <button type="submit" name="course_submit_btn" value="submit_for_review"><?php _e('Submit for Review', 'tutor');
                                ?></button>
								<?php
							}
							?>
