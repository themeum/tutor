							...
							<div class="tutor-frontend-builder-item-scope">
								<div class="tutor-form-group">
									...
									<div class="tutor-form-field-course-tags">
										<?php
										// echo tutor_course_tags_checkbox($course_id);
										...
										<div class="tutor-row tutor-align-items-center">
											<div class="tutor-col-5">
												<div class="builder-course-thumbnail-img-src">
													...
													?>
													<img width="280" src="<?php echo esc_url( $_thumbnail_url ); ?>" class="thumbnail-img" data-placeholder-src="<?php echo esc_url( $builder_course_img_src ); ?>">
