            ...
            <div class="tutor-row">
                <div class="tutor-col">
                    <div class="tutor-dashboard-builder-header-left">
                        ...
                        <div class="tutor-dashboard-builder-draft">
                            <button type="submit" class="tutor-button default-btn tutor-dashboard-builder-draft-btn" name="course_submit_btn" value="save_course_as_draft"><i class="tutor-icon-default"></i><?php _e('Save', 'tutor'); ?></button>
                        </div>
                    </div>
                </div>
        ...
        <div class="tutor-row">
            ...
            <div class="tutor-col-4">
                <div class="tutor-course-builder-upload-tips">
                    <h3><?php _e('Course Upload Tips', 'tutor') ?></h3>
                    <ul>
