...
<div class="tutor-dashboard-content-inner my-courses">
	...
	<div class="tutor-course-listing tutor-course-listing-grid-3">
        ...
        <div>
            ...
            <p><?php esc_html_e("Sorry, there is no pending courses." , 'tutor'); ?></p>
        </div>
	    <?php endif; ?>
    ...
    <div class="tutor-frontend-modal" data-popup-rel="#tutor-course-delete" style="display: none">
        ...
        <div class="tutor-frontend-modal-content">
            ...
            <div class="tutor-modal-body tutor-course-delete-popup">
                ...
                <h3><?php esc_html_e('Delete This Course?', 'tutor'); ?></h3>
                <p><?php esc_html_e("You are going to delete this course, it can't be undone", 'tutor'); ?></p>
