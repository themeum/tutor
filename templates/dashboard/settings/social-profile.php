...
<div class="tutor-dashboard-setting-social tutor-dashboard-content-inner">
	...
	<div class="tutor-dashboard-inline-links">
		...
		?>
		<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mt-32"><?php esc_html_e( 'Social Profile Link', 'tutor' ) ?></div>
	</div>
		...
		foreach ( $tutor_user_social_icons as $key => $social_icon ) {
			?>
				<div class="tutor-row tutor-align-items-center tutor-mb-32 tutor-social-field">
					<div class="tutor-col-12 tutor-col-sm-4 tutor-col-md-12 tutor-col-lg-3 tutor-d-flex tutor-align-items-center">
						<i class="<?php echo esc_html( $social_icon['icon_classes'] ); ?> tutor-icon-20 tutor-mr-4"></i>
