		...
		if ( tutor_utils()->count( $tutor_withdrawal_methods ) ) {
			...
			<div class="withdraw-method-select-wrap">
				...
				foreach ( $tutor_withdrawal_methods as $method_id => $method ) {
					?>
					<div class="withdraw-method-select withdraw-method-<?php echo esc_attr( $method_id ); ?>" data-withdraw-method="<?php echo esc_attr( $method_id ); ?>">
						...
						<label for="withdraw_method_select_<?php echo esc_attr( $method_id ); ?>">
							...
							echo tutor_utils()->tutor_price( $min_withdraw_amount );
							?>
								</span>
						</label>
					</div>
			...
			<div class="withdraw-method-forms-wrap">
				...
				foreach ( $tutor_withdrawal_methods as $method_id => $method ) {
					...
					<div id="withdraw-method-form-<?php echo esc_attr( $method_id ); ?>" class="withdraw-method-form withdraw-method-form-<?php echo esc_attr( $method_id ); ?>" style="display: none;">
