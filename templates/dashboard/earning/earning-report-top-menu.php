	...
	<div class="tutor-date-range-wrap">
		<form action="" class="report-date-range-form" method="get">
			...
			<div class="date-range-input">
				<input type="text" name="date_range_from" class="tutor_date_picker" value="<?php echo sanitize_title_with_dashes( '' !== $date_range_from ? tutor_get_formated_date( get_option( 'date_format' ), $date_range_from ) : '' ); ?>" autocomplete="off" placeholder="<?php echo __( get_option( 'date_format' ), 'tutor' ); ?>" />
				<i class="tutor-icon-calender-bold-filled"></i>
			</div>

			<div class="date-range-input">
				<input type="text" name="date_range_to" class="tutor_date_picker" value="<?php echo sanitize_title_with_dashes( '' !== $date_range_to ? tutor_get_formated_date( get_option( 'date_format' ), $date_range_to ) : '' ); ?>" autocomplete="off" placeholder="<?php echo __( get_option( 'date_format' ), 'tutor' ); ?>" />
				<i class="tutor-icon-calender-bold-filled"></i>
			</div>

			<div class="date-range-input">
				<button type="submit"><i class="tutor-icon-magnifying-glass-line"></i> </button>
			</div>
		</form>
	</div>
</div>
