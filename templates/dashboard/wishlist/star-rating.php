...
$current_rating      = isset( $course_rating->rating_avg ) ? (float) $course_rating->rating_avg : 0.0;
$has_rating          = $current_rating > 0;
$show_course_ratings = apply_filters( 'tutor_show_course_ratings', true, get_the_ID() );
?>

<div class="<?php echo esc_attr( $wrapper_class ); ?> tutor-text-exception4" data-rating-value="<?php echo esc_attr( number_format( $current_rating, 2, '.', '' ) ); ?>">
	<?php
