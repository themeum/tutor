        ...
        <div class="tutor-form-row">
            <div class="tutor-form-col-6">
                <div class="tutor-form-group">
                    ...
                    <input type="text" name="first_name" value="<?php echo esc_html_e(tutor_utils()->input_old('first_name')); ?>" placeholder="<?php esc_html_e('First Name', 'tutor'); ?>" required autocomplete="given-name">
                </div>
            </div>
            ...
            <div class="tutor-form-col-6">
                <div class="tutor-form-group">
                    ...
                    <input type="text" name="last_name" value="<?php echo esc_html_e(tutor_utils()->input_old('last_name')); ?>" placeholder="<?php esc_html_e('Last Name', 'tutor'); ?>" required autocomplete="family-name">
                </div>
            </div>
        ...
        <div class="tutor-form-row">
            ...
            <div class="tutor-form-col-6">
                <div class="tutor-form-group">
                    ...
                    <input type="text" name="user_login" class="tutor_user_name" value="<?php echo esc_html_e(tutor_utils()->input_old('user_login')); ?>" placeholder="<?php esc_html_e('User Name', 'tutor'); ?>" required autocomplete="username">
                </div>
            </div>
            ...
            <div class="tutor-form-col-6">
                <div class="tutor-form-group">
                    ...
                    <input type="text" name="email" value="<?php echo esc_html_e(tutor_utils()->input_old('email')); ?>" placeholder="<?php esc_html_e('E-Mail', 'tutor'); ?>" required autocomplete="email">
                </div>
            </div>
        ...
        <div class="tutor-form-row">
            <div class="tutor-form-col-6">
                <div class="tutor-form-group">
                    ...
                    <input type="password" name="password" value="<?php echo esc_html_e(tutor_utils()->input_old('password')); ?>" placeholder="<?php esc_html_e('Password', 'tutor'); ?>" required autocomplete="new-password">
                </div>
            </div>
            ...
            <div class="tutor-form-col-6">
                <div class="tutor-form-group">
                    ...
                    <input type="password" name="password_confirmation" value="<?php echo esc_html_e(tutor_utils()->input_old('password_confirmation')); ?>" placeholder="<?php esc_html_e('Password Confirmation', 'tutor'); ?>" required autocomplete="new-password">
                </div>
            </div>
        </div>
