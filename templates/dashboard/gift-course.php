...
<div class="tutor-gift-course-card">
	<div class="gift-card-container">
		...
		<div class="gift-card-decoration-left">
		...
		<div class="gift-box-icon">
			<svg width="70" height="80" viewBox="0 0 77 94" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<svg class="gift-box-icon-star gift-box-icon-star-2"  width="9" height="8" viewBox="0 0 9 8" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<svg class="gift-box-icon-star gift-box-icon-star-1" width="8" height="7" viewBox="0 0 8 7" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="gift-card-content">
			<h2 class="gift-card-title tutor-fs-4 tutor-fw-medium tutor-color-primary tutor-m-0"><?php esc_html_e( 'Congratulations!', 'tutor' ); ?></h2>
			<p class="gift-card-message tutor-fs-6 tutor-lh-1-5 tutor-fw-medium tutor-m-0">
				<?php esc_html_e( 'You have received a Gift from', 'tutor' ); ?> <span class=""><?php esc_html_e( 'Joe Nevarro', 'tutor' ); ?></span>
			</p>
			<button class="gift-card-button tutor-btn tutor-btn-sm tutor-btn-primary tutor-btn-md tutor-mt-16"><?php esc_html_e( 'Open it Up', 'tutor' ); ?></button>
		</div>
