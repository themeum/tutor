			...
			<div>
				<div class="tutor-withdrawal-pop-up-success">
					<div>
						...
						<div style="text-align:center">
							...
							<div class="tutor-fs-4 tutor-fw-normal"><?php esc_html_e( 'Your withdrawal request has been successfully accepted', 'tutor' ); ?></div>
							<span class="tutor-fs-6 tutor-fw-normal tutor-color-black-60"><?php esc_html_e( 'Please check your transaction notification on your connected withdrawal method', 'tutor' ); ?></span>
						</div>
						<br />
						<br />
				...
				<div class="tutor-withdrawal-op-up-frorm ">
					...
					<div>
						...
						<div class="text-medium-h5 tutor-color-black tutor-mt-20">
							<?php esc_html_e( 'Withdrawal Request', 'tutor' ); ?>
						</div>
