...
<?php do_action('lms_course/single/enrolled/after/lead_info'); ?>
    ...
    <div <?php lms_post_class(); ?>>
		...
		<?php do_action('lms_course/single/enrolled/after/topics'); ?>
		...
		<?php do_action('lms_course/single/enrolled/before/content'); ?>
		<?php lms_course_content(); ?>
		<?php do_action('lms_course/single/enrolled/after/content'); ?>
