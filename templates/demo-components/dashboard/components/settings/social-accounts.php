...
<section class="tutor-flex tutor-flex-col tutor-gap-4">
	<div class="tutor-h5"><?php echo esc_html__( 'Social Profile Link', 'tutor' ); ?></div>

	<div class="tutor-surface-l1 tutor-rounded-2xl tutor-p-6 tutor-border">
		<form
			...
			class="tutor-flex tutor-flex-col tutor-gap-5"
		>
			<?php
			$social_fields = array(
				'facebook' => array(
			...
			foreach ( $social_fields as $key => $field ) :
				?>
				<div class='tutor-grid tutor-gap-3' style="grid-template-columns: auto 1fr;">
					<!-- Social icon -->
					...
					<div class="tutor-input-field" :class="{
						...
						<label for="<?php echo esc_attr( $key ); ?>" class="tutor-label tutor-flex tutor-items-center tutor-gap-2">
