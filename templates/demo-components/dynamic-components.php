...
<pre><code>
&lt;?php
	echo Button::make()->label( 'I am a button' )->size( 'large' )->color( 'primary' )->render(); // phpcs:ignore
	echo Button::make()->label( 'I am a button' )->size( 'medium' )->color( 'primary' )->render(); // phpcs:ignore
	echo Button::make()->label( 'I am a button' )->size( 'small' )->color( 'primary' )->render(); // phpcs:ignore
	echo Button::make()->label( 'I am a button' )->color( 'primary-soft' )->render(); // phpcs:ignore 
	echo Button::make()->label( 'I am a button' )->color( 'destructive' )->render(); // phpcs:ignore 
	echo Button::make()->label( 'I am a button' )->color( 'destructive-soft' )->render(); // phpcs:ignore 
?&gt;
</code></pre>
...
echo Button::make()->label( 'I am a button' )->size( 'small' )->color( 'primary' )->render(); // phpcs:ignore 
echo Button::make()->label( 'I am a button' )->color( 'primary-soft' )->render(); // phpcs:ignore 
echo Button::make()->label( 'I am a button' )->color( 'primary-soft' )->attr( 'class', 'tutor-btn-loading' )->render(); // phpcs:ignore 
echo Button::make()->label( 'I am a button' )->color( 'destructive' )->render(); // phpcs:ignore 
echo Button::make()->label( 'I am a button' )->color( 'destructive-soft' )->render(); // phpcs:ignore 
echo Button::make()->size( 'large' )->icon(
	'<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					</svg>' )->color( 'primary-soft' )->render(); // phpcs:ignore
  
echo Button::make()->attr( 'class', 'tutor-btn-block' )->label( 'I am a block button' )->color( 'primary-soft' )->render(); // phpcs:ignore
?>
