...
<div class="btn-wrapper tutor-mb-12">
	...
	<pre><code>
	&lt;?php
		Button::make()->label( 'I am a button' )->size( 'large' )->variant( 'primary' )->render(); // phpcs:ignore
		Button::make()->label( 'I am a button' )->size( 'medium' )->variant( 'primary' )->render(); // phpcs:ignore
		Button::make()->label( 'I am a button' )->size( 'small' )->variant( 'primary' )->render(); // phpcs:ignore
		Button::make()->label( 'I am a button' )->variant( 'primary-soft' )->render(); // phpcs:ignore 
		Button::make()->label( 'I am a button' )->variant( 'destructive' )->render(); // phpcs:ignore 
		Button::make()->label( 'I am a button' )->variant( 'destructive-soft' )->render(); // phpcs:ignore 
	?&gt;
	</code></pre>
	...
	<div class="tutor-dynamic-btn-wrapper tutor-flex tutor-gap-3 tutor-items-center tutor-flex-wrap">
        ...
        Button::make()->label( 'I am a button' )->size( 'small' )->variant( 'primary' )->render(); // phpcs:ignore 
        Button::make()->label( 'I am a button' )->variant( 'primary-soft' )->render(); // phpcs:ignore 
        Button::make()->label( 'I am a button' )->variant( 'primary-soft' )->attr( 'class', 'tutor-btn-loading' )->render(); // phpcs:ignore 
        Button::make()->label( 'I am a button' )->variant( 'destructive' )->render(); // phpcs:ignore 
        Button::make()->label( 'I am a button' )->variant( 'destructive-soft' )->render(); // phpcs:ignore 
		Button::make()->size( 'large' )->icon(
        ...
        Button::make()->attr( 'class', 'tutor-btn-block' )->label( 'I am a block button' )->variant( 'primary-soft' )->render(); // phpcs:ignore
		?>
	</div>
</div>
