...
$enroll_btn = '<div class="tutor-course-list-btn">' . apply_filters( 'tutor_course_restrict_new_entry', '<a href="' . get_the_permalink() . '" class="' . apply_filters( 'tutor_course_loop_button_class', 'tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block', $course_id ) . ' ' . $button_class . ' " data-course-id="' . $course_id . '" ' . trim( $attrs_string ) . '>' . __( 'Enroll Course', 'tutor' ) . '</a>', $course_id ) . '</div>';
	...
	if ( $product && 0 != $maximum_students && $total_enrolled != $maximum_students ) {
		...
		echo '<div class="tutor-d-flex tutor-align-center tutor-justify-between">
                ...
                <div class="tutor-course-booking-availability tutor-mt-16">
                    <button class="' . apply_filters( 'tutor_course_loop_button_class', 'tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block', $course_id ) . '">' .
