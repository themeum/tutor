...
<?php
    ...
    if (tutor_utils()->is_course_purchasable()) {
            ...
            if ($maximum_students != 0 && $total_enrolled != $maximum_students){
                ...
                $price_html = '<div class="list-item-price-with-booking tutor-bs-d-flex tutor-bs-align-items-center tutor-bs-justify-content-between"><div class="list-item-price tutor-bs-d-flex tutor-bs-align-items-center"> <span class="price tutor-text-bold-h6 tutor-color-text-primary"> '.$free_html . ' </span></div>';
