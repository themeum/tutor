...
<?php
    ...
    if (tutor_utils()->is_course_purchasable()) {
            ...
            if(false === $product){
                ...
                $cart_html = '<div class="list-item-button tutor-mt-16 booking-available"><div class="tutor-btn tutor-btn-icon tutor-btn-disable-outline tutor-btn-md tutor-btn-full tutor-color-black"> <span class="tutor-icon-cart-line-filled" style="font-size: 24px;"></span> '.apply_filters( 'tutor_course_restrict_new_entry', $add_to_cart_text ) . ' </div></div>';

                echo tutor_kses_html($price_html);
                echo tutor_kses_html($percet_html);
            ...
            $cart_html = '<div class="list-item-button tutor-mt-15 booking-available">
                            <div class="tutor-btn tutor-btn-icon tutor-btn-disable-outline tutor-btn-md tutor-btn-full tutor-color-text-primary"> 
                                <!--<span class="tutor-icon-cart-line-filled" style="font-size: 24px;">
                                
                                </span>--> '.
                                // apply_filters( 'tutor_course_restrict_new_entry', $add_to_cart_text ) . 
                                $enroll_btn .
                            ' </div>
                        </div>';
