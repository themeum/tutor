...
if ( $is_course_in_user_cart ) {
	?>
	<a href="<?php echo esc_url( $cart_page_url ? $cart_page_url : '#' ); ?>" class="<?php echo esc_attr( apply_filters( 'tutor_course_loop_button_class', 'tutor-btn tutor-btn-outline-primary tutor-btn-md', $course_id ) . ' ' . ( $cart_page_url ? '' : 'tutor-cart-page-not-configured' ) ); ?>">
	...
	<div class="list-item-button"> 
		<button data-quantity="1" class="<?php echo esc_attr( apply_filters( 'tutor_course_loop_button_class', 'tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block', $course_id ) . ' ' . $conditional_class ); ?>" data-course-id="<?php the_ID(); ?>" rel="nofollow">
