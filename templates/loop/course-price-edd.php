...
<?php
    ...
    if (tutor_utils()->is_course_purchasable()) {
            ...
            if ( $maximum_students == $total_enrolled && $maximum_students != 0) {
                $price_html = '<div class="tutor-bs-d-flex tutor-bs-align-items-center tutor-bs-justify-content-between"><div class="list-item-price tutor-bs-d-flex tutor-bs-align-items-center"> <span class="price tutor-text-bold-h6 tutor-color-text-primary">'.$edd_price . ' </span></div>';
