...
<div class="tutor-course-loop-price">
    ...
    $enroll_btn = '<div  class="tutor-loop-cart-btn-wrap"><a href="'.$cart_url.'" class="tutor-btn tutor-btn-icon tutor-btn-disable-outline tutor-btn-ghost tutor-no-hover tutor-btn-md"><span class="btn-icon tutor-icon-cart-line-filled"></span><span>'.__('View Cart', 'tutor'). '</span></a></div>';
