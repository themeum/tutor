...
if ( is_array( $attachments ) && count( $attachments ) ) {
	...
	<div class="tutor-page-segment tutor-attachments-wrap">
		...
		foreach ( $attachments as $attachment ) {
			?>
			<a href="<?php echo esc_url( $attachment->url ); ?>" <?php echo ( $open_mode_view ? esc_attr( $open_mode_view ) : ' download="' . esc_attr( $attachment->name ) . '" ' ); ?> class="tutor-lesson-attachment clearfix">
