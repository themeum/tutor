				...
				'blocks'   => array(
					...
					array(
						...
						'fields'     => array(
							...
							array(
								'key'         => 'instructor_can_change_author',
								'type'        => 'toggle_switch',
								'label'       => __( 'Allow Instructors to Change Author', 'tutor' ),
								'label_title' => '',
								'default'     => 'on',
								'desc'        => __( 'Enable this setting to let instructors change the course author.', 'tutor' ),
							),
						),
					),
				),
