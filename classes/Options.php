				...
				'sections'    => array(
					...
					'enable_disable' => array(
						...
						'fields' => array(
							...
							'disable_course_total_hour' => array(
								'type'      => 'checkbox',
								'label'     => __('Course total hour', 'tutor'),
								'label_title' => __('Disable','tutor'),
								'default'   => '0',
								'desc'      => __('Disabling this feature will be removed course total hour from the course page.', 'tutor'),
							),
