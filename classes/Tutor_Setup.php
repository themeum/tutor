                ...
                $html .= '<li class="'.($i==1 ? "active" : "").'">';
                    $html .= '<div class="tutor-setup-content-heading heading">';
                        ...
                        $html .= '<div class="step-info">';
                            $html .= '<span class="tutor-fs-7 tutor-fw-normal tutor-color-muted">'.__('Step', 'tutor').':</span> <strong class="tutor-color-black">'.$i.'/'.count($field_arr).' </strong>';
                        $html .= '</div>';
                    ...
                    $html .= '<div class="tutor-setup-content-heading body">';
                        ...
                        foreach ($field_parent['attr'] as $key => $field) {
                            ...
                            $html .= '<div class="tutor-setting'.(in_array( $field['type'], $full_width_fields ) ? " course-setting-wrapper" : "").' '.(isset($field['class']) ? $field['class'] : '').'">';
                                $html .= isset( $field['lable'] ) ? '<div class="tutor-fs-6 tutor-fw-normal  tutor-color-black ______">'.$field['lable'] : '';
                                ...
                                if(!in_array($field['type'], $down_desc_fields)) {
                                    $html .= isset( $field['desc'] ) ? '<div class="content tutor-fs-7 tutor-fw-normal tutor-color-black-60">'.$field['desc'].'</div>' : '';
                                }
            ...
            <div class="tutor-wizard-container">
                <div class="tutor-wrapper-boarding tutor-setup-wizard-boarding active">
                    <div class="wizard-boarding-header">
                        ...
                        <div>
                            <div class="wizard-boarding-header-sub tutor-fs-5 tutor-fw-normal  tutor-color-black">
                                <?php printf(__('Hello %s, welcome to Tutor LMS!', 'tutor'), $current_user->user_login); ?>
                            </div>
                            <div class="wizard-boarding-header-main tutor-fs-2 tutor-fw-medium tutor-color-black tutor-mt-12">
                    ...
                    <div class="wizard-boarding-body tutor-mt-60">
                        <ul class="slider tutor-boarding">
                            <li>
                                ...
                                <div class="slide-subtitle tutor-fs-6 tutor-fw-normal tutor-color-black-60 tutor-mt-16">
