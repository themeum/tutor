...
class Assets {
	...
	public function get_default_localized_data() {
		...
		return array(
			...
			'assignment_allowed_file_types' => 'tutor_assignments' === $post_type ? array(
				...wp_get_ext_types()['image'],
				...wp_get_ext_types()['document'],
				...wp_get_ext_types()['spreadsheet'],
				...wp_get_ext_types()['interactive'],
				...wp_get_ext_types()['text'],
			) : '',
